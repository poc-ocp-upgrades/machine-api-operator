...
func (optr *Operator) Run(workers int, stopCh <-chan struct{}) {
	...
	if !cache.WaitForCacheSync(stopCh, optr.deployListerSynced) {
...
func (optr *Operator) maoConfigFromInfrastructure() (*OperatorConfig, error) {
	...
	return &OperatorConfig{TargetNamespace: optr.namespace, Controllers: Controllers{Provider: providerControllerImage, NodeLink: machineAPIOperatorImage, MachineHealthCheck: machineAPIOperatorImage, MachineHealthCheckEnabled: true}}, nil
}
